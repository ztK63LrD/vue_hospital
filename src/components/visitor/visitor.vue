  ...
  <div class="visitor">
    <div class="top">
      ...
      <div class="right">
        ...
        <el-popconfirm :title="`你确认要删除${user.name}吗？`" width="200" @confirm="removeUser">
          <template #reference> 
            <el-button v-show="$route.path == '/user/patient'" circle type="danger" size="default" :icon="Delete">
            </el-button>
          </template>
        </el-popconfirm>
      </div>
    ...
    <div class="bottom">
      ...
      <p>当前地址：{{ user.param.cityString }}</p>
...
// 相应就诊人组件按钮的回调
const handler = () => {
  // 要么是就诊人管理模块点击修改按钮，要么是预约挂号点击修改按钮
